...
import { alertCircleOutline, homeOutline, personCircleOutline, addCircleOutline, pawOutline } from 'ionicons/icons';

addIcons({ alertCircleOutline, homeOutline, personCircleOutline, addCircleOutline, pawOutline});
